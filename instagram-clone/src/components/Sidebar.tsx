...
export default function Sidebar() {
  ...
  return (
    <div className="w-[245px] border-r border-gray-200 h-screen flex flex-col fixed left-0 top-0 bg-white">
      <div className="py-8 px-4">
        <Link href="/feed" className="block">
          <h1 className="text-2xl font-semibold instagram-logo text-black">Instagram</h1>
        </Link>
      </div>
      ...
      <nav className="flex-grow">
        <ul className="space-y-1">
          <li>
            <Link
              href="/feed"
              className={`flex items-center px-4 py-3 hover:bg-gray-50 rounded-md ${isActive('/feed') ? 'font-bold' : ''}`}
            >
              <svg
                aria-label="Home"
                className="_ab6-"
                color={isActive('/feed') ? "rgb(0, 0, 0)" : "rgb(38, 38, 38)"}
                fill={isActive('/feed') ? "rgb(0, 0, 0)" : "rgb(38, 38, 38)"}
                height="24"
                role="img"
                viewBox="0 0 24 24"
                width="24"
          ...
          <li>
            <Link
              href="#"
              className="flex items-center px-4 py-3 hover:bg-gray-50 rounded-md"
            >
              <svg aria-label="Search" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height="24" role="img" viewBox="0 0 24 24" width="24">
          ...
          <li>
            <Link
              ...
              className="flex items-center px-4 py-3 hover:bg-gray-50 rounded-md"
            >
              <svg aria-label="Messages" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height="24" role="img" viewBox="0 0 24 24" width="24">
              ...
              <div className="flex items-center">
                ...
                <span className="bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center ml-2">1</span>
              </div>
            </Link>
          </li>
          ...
          <li>
            <Link
              ...
              className="flex items-center px-4 py-3 hover:bg-gray-50 rounded-md"
            >
              <svg aria-label="Notifications" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height="24" role="img" viewBox="0 0 24 24" width="24">
          ...
          <li>
            <Link
              ...
              className="flex items-center px-4 py-3 hover:bg-gray-50 rounded-md"
            >
              <svg aria-label="Create" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height="24" role="img" viewBox="0 0 24 24" width="24">
          ...
          <li>
            <Link
              href="/profile"
              className={`flex items-center px-4 py-3 hover:bg-gray-50 rounded-md ${isActive('/profile') ? 'font-bold' : ''}`}
            >
              {user && (
                <>
      ...
      <div className="mt-auto px-4 pb-6">
        <Link
          ...
          className="flex items-center px-4 py-3 hover:bg-gray-50 rounded-md"
        >
          <svg aria-label="Settings" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height="24" role="img" viewBox="0 0 24 24" width="24">
